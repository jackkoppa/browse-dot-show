...
1. **Download the static binaries:**
   ...
   curl -L --fail-with-body -o mongodb-js-zstd__msgpackr.zip "https://api.nodelayer.xyz/arm64/layers/generate?version=v24.0.0&packages=@msgpackr-extract/msgpackr-extract-linux-arm64,@mongodb-js/zstd,msgpackr"
   ```
