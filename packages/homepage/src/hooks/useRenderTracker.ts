...
/**
 * Simple computation tracker - call outside of other hooks
 */
export const trackComputation = (name: string, dependencies: any[]) => {
  console.log(`🧮 [Computation] ${name} dependencies:`, dependencies)
}